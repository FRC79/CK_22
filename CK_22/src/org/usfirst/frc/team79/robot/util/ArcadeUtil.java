...
public class ArcadeUtil extends RobotDriveBase {
   ...
   * @param frontLeft the leader of the left drive train
   * @param frontRight the leader of the right drive train
   */
  public ArcadeUtil(TalonSRX frontLeft, TalonSRX frontRight) {
    leftMotor = frontLeft;
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squaredInputs) {
    ...
    leftMotor.set(ControlMode.PercentOutput, limit(leftMotorOutput) * m_maxOutput);
    rightMotor.set(ControlMode.PercentOutput, -limit(rightMotorOutput) * m_maxOutput);
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
    ...
    leftMotor.set(ControlMode.PercentOutput, leftMotorOutput * m_maxOutput);
    rightMotor.set(ControlMode.PercentOutput, -rightMotorOutput * m_maxOutput);
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squaredInputs) {
    ...
    leftMotor.set(ControlMode.PercentOutput, leftSpeed * m_maxOutput);
    rightMotor.set(ControlMode.PercentOutput, -rightSpeed * m_maxOutput);
